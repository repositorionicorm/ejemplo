...
!function ($) {
    ...
    BootstrapTable.prototype.fitFooter = function () {
        ...
        if (this.$el.is(':hidden')) {
            this.timeoutFooter_ = setTimeout($.proxy(this.fitFooter, this), 0);
            return;
        }
    ...
    var allowedMethods = [
        ...
        'insertRow', 'updateRow', 'updateCell', 'updateByUniqueId', 'removeByUniqueId','removeRow',
