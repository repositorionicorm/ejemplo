...
function cargar() {
    ...
    llenaCombos("#cboTipoAsiento", "../utilitario/tipoAsientoSysone", "id", "descripcion");
    llenaCombos("#cmbAgencia", "../utilitario/agencias", "id", "descripcion");
    $tablaDetalle = $("#tblMostrarDetalleSysone");

    $("#btnFiltrarIntegraciones").click(traerIntegraciones);
...
function traerIntegraciones() {
    ...
    var tipoAsientoId = $("#cboTipoAsiento").val();
    var agenciaId = $("#cmbAgencia").val();


    $("#contenedorTabla").hide();
    mostrarMensajeCargando(Mensajes.general_cargando, '.mensajeSysone', 'h4');
    $.getJSON("traerIntegracion/" + tipoAsientoId + "/" + agenciaId, function (data) {
...
function integrarAsiento() {
    $("#sysoneIntegrando").removeClass('hide');
    ...
    $.getJSON("integrarAsiento?tipoAsientoId=" + rowActivo.tipoAsientoId + "&fecha=" + rowActivo.fechaString + "&agencia=" + rowActivo.agenciaId, function (data) {
        $("#sysoneIntegrando").addClass('hide');
        $("#modalDetalleSysone").modal('hide');
        $("#btnFiltrarIntegraciones").trigger('click');
...
function mostrarDetalle(row) {
    ...
    $("#lblAgencia").html(agenciaDescripcion)
    $("#btnIntegrarAsiento").removeAttr('disabled');
    $("#btnExportarExcel").removeAttr('disabled');
    $("#btnCerrar").removeAttr('disabled');
    $("#detalleSysoneProcesando").removeClass('hide');

    $.getJSON("traerAsiento?tipoAsientoId=" + tipoAsiento + "&fecha=" + fecha + "&agencia=" + agenciaId, function (data) {
        $("#detalleSysoneProcesando").addClass('hide');
...
$(window).resize(function () {
    $('#tblMostrarDetalleSysone').bootstrapTable('resetView');
});